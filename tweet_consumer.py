...
sc = SparkContext(appName="TwitterCrypto")
ssc = StreamingContext(sc,5)
ss = SparkSession.builder.appName("TwitterCrypto").config("spark.sql.warehouse.dir", "/user/hive/warehouse").config("hive.metastore.uris", "thrift://localhost:9083").enableHiveSupport().getOrCreate()                                                                                                  
